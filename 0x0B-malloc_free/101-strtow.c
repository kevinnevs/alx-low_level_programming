...
#include <stdlib.h>
/**
 * checker - a func that checks function
 * @word: word count
 * @len: the length
 * @str: string to go through
 * @s: array that you are assigning
 * Return: char value
 */
char **checker(int word, int len, char *str, char **s)
{
	int i, k, j;
...
/**
 * strtow - a func that turns string to words
 * @str: string to check
